...
public class RecyclerAdaper_Azmoon_9_1 extends RecyclerView.Adapter<RecyclerAdaper_Azmoon_9_1.MyViewHolder> {

    private int lastPosition = -1;
    private boolean iscolor = true;
    private List<Model_Azmoon_9_1> itemList;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            btn_1 = (Button) itemView.findViewById(R.id.btn_1_azmoon_9_1);
            btn_2 = (Button) itemView.findViewById(R.id.btn_2_azmoon_9_1);
            btn_3 = (Button) itemView.findViewById(R.id.btn_3_azmoon_9_1);
            btn_4 = (Button) itemView.findViewById(R.id.btn_4_azmoon_9_1);
            btn_5 = (Button) itemView.findViewById(R.id.btn_5_azmoon_9_1);
            btn_6 = (Button) itemView.findViewById(R.id.btn_6_azmoon_9_1);
            btn_7 = (Button) itemView.findViewById(R.id.btn_7_azmoon_9_1);
            btn_8 = (Button) itemView.findViewById(R.id.btn_8_azmoon_9_1);
            ...
            tv_1 = (TextView) itemView.findViewById(R.id.tv_1_azmoon_9_1);
            tv_2 = (TextView) itemView.findViewById(R.id.tv_2_azmoon_9_1);
            tv_3 = (TextView) itemView.findViewById(R.id.tv_3_azmoon_9_1);
            tv_4 = (TextView) itemView.findViewById(R.id.tv_4_azmoon_9_1);
            tv_5 = (TextView) itemView.findViewById(R.id.tv_5_azmoon_9_1);
            tv_6 = (TextView) itemView.findViewById(R.id.tv_6_azmoon_9_1);
            tv_7 = (TextView) itemView.findViewById(R.id.tv_7_azmoon_9_1);
            tv_8 = (TextView) itemView.findViewById(R.id.tv_8_azmoon_9_1);
    ...
    public RecyclerAdaper_Azmoon_9_1(Context context, List<Model_Azmoon_9_1> itemList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_azmoon_9_1, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final Model_Azmoon_9_1 Item = itemList.get(position);
        ...
        holder.btn_okk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                holder.tv_correct.setText(Azmoon_9_1.ANSEVER[position]);

                if (all.equals(all2)) {

                    holder.tv_correct.setVisibility(View.VISIBLE);

                    save.save(AppController.SAVE_SCORE_AZMOON, (float) (save.load(AppController.SAVE_SCORE_AZMOON, 0f)) + 0.55f);
