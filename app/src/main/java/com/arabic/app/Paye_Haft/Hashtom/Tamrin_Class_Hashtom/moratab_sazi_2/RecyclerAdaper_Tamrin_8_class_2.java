        ...
        holder.btn_okk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rb.getTag().toString().equals(String.valueOf(correct))) {
                    ...
                    String aa = "";
                    switch (Tamrin_8_class_2.javab[position]) {
                        case 1:
                            aa = holder.rb_tamrin_8_class_2_1.getText().toString();
                            break;
                        case 2:
                            aa = holder.rb_tamrin_8_class_2_2.getText().toString();
                            break;
                        case 3:
                            aa = holder.rb_tamrin_8_class_2_3.getText().toString();
                            break;
                        case 4:
                            aa = holder.rb_tamrin_8_class_2_4.getText().toString();
                            break;
                        case 5:
                            aa = holder.rb_tamrin_8_class_2_5.getText().toString();
                            break;
                        case 6:
                            aa = holder.rb_tamrin_8_class_2_6.getText().toString();
                            break;
                    }
