...
public class Model_TrueFalse_9_home_3 {
    ...
    public Model_TrueFalse_9_home_3(int i, String quiz) {
    }

    public Model_TrueFalse_9_home_3(int id, String title, String rb_char1, String rb_char2, int id_correct) {
        this.id = id;
        this.title = title;
