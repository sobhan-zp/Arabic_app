...
public class Model_jayeKhali_8_home_5 {
    ...
    private String rb_char4;
    private int id_correct;

    public Model_jayeKhali_8_home_5(int i, String quiz) {
    }
    ...
    public String getRb_char4() {
        return rb_char4;
    }

    public void setRb_char4(String rb_char4) {
        this.rb_char4 = rb_char4;
    }
    ...
    public Model_jayeKhali_8_home_5(int id, String title, String rb_char1, String rb_char2, String rb_char3, String rb_char4, int id_correct) {
        this.id = id;
        this.title = title;
        this.rb_char1 = rb_char1;
        this.rb_char2 = rb_char2;
