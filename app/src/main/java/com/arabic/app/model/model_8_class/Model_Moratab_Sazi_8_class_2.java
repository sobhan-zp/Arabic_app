...
public class Model_Moratab_Sazi_8_class_2 {
    ...
    private String rb_6_mazi;
    private int correct;

    public Model_Moratab_Sazi_8_class_2() {
    }
    ...
    public String getRb_6_mazi() {
        return rb_6_mazi;
    }

    public void setRb_6_mazi(String rb_6_mazi) {
        this.rb_6_mazi = rb_6_mazi;
    }
    ...
    public Model_Moratab_Sazi_8_class_2(int id, String title, String rb_1_mazi, String rb_2_mazi, String rb_3_mazi, String rb_4_mazi, String rb_5_mazi, String rb_6_mazi, int correct) {
        this.id = id;
        this.title = title;
        this.rb_1_mazi = rb_1_mazi;
        this.rb_2_mazi = rb_2_mazi;
