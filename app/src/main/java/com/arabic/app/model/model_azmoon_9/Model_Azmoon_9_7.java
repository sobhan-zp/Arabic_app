...
public class Model_Azmoon_9_7 {
    ...
    public Model_Azmoon_9_7(int i, String quiz) {
    }

    public Model_Azmoon_9_7(int id, String title, String rb_char1, String rb_char2, int id_correct) {
        this.id = id;
        this.title = title;
