...
public class Model_Azmoon_9_8 {
    ...
    public Model_Azmoon_9_8(int i, String quiz) {
    }

    public Model_Azmoon_9_8(int id, String title, String rb_char1, String rb_char2, String rb_char3, int id_correct) {
        this.id = id;
        this.title = title;
