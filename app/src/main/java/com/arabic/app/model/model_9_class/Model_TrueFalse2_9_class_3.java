...
public class Model_TrueFalse2_9_class_3 {
    ...
    public Model_TrueFalse2_9_class_3(int i, String quiz) {
    }

    public Model_TrueFalse2_9_class_3(int id, String title, String rb_char1, String rb_char2, int id_correct) {
        this.id = id;
        this.title = title;
