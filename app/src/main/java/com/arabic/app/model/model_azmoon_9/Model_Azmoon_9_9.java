...
public class Model_Azmoon_9_9 {
    ...
    public Model_Azmoon_9_9(int i, String quiz) {
    }

    public Model_Azmoon_9_9(int id, String title, String rb_char1, String rb_char2, String rb_char3 , String rb_char4 , int id_correct) {
        this.id = id;
        this.title = title;
    ...
    public void setRb_char4(String rb_char3) {
        this.rb_char3 = rb_char3;
    }
