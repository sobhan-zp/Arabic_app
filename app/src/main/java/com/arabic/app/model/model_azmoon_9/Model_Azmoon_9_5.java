...
public class Model_Azmoon_9_5 {
    ...
    public Model_Azmoon_9_5(int id, String title, String rb_1_mazi, String rb_2_mazi, String rb_3_mazi, String rb_4_mazi, String rb_5_mazi, int correct) {
        this.id = id;
        this.title = title;
        this.rb_1_mazi = rb_1_mazi;
        this.rb_2_mazi = rb_2_mazi;
